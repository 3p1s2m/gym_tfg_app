...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _abrirEdicionPerfil() async {
    ...
    TextEditingController pesoCtrl = TextEditingController(text: _datosUsuario!["peso"]?.toString() ?? "");
    TextEditingController alturaCtrl = TextEditingController(text: _datosUsuario!["altura"]?.toString() ?? "");
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: TextField(controller: pesoCtrl, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: "Peso (kg)", labelStyle: TextStyle(color: Colors.grey), enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: Colors.white38))))),
                        const SizedBox(width: 15),
                        Expanded(child: TextField(controller: alturaCtrl, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: "Altura (cm)", labelStyle: TextStyle(color: Colors.grey), enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: Colors.white38))))),
                      ],
                    ),
                    const SizedBox(height: 15),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      appBar: AppBar(
        title: const Text('MI PERFIL', style: TextStyle(fontWeight: FontWeight.bold, letterSpacing: 2.0)),
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  _buildStatItem("Peso", _datosUsuario!["peso"] != null ? "${_datosUsuario!["peso"]} kg" : "--"),
                  Container(width: 1, height: 40, color: Colors.grey.withValues(alpha:0.3)),
                  _buildStatItem("Altura", _datosUsuario!["altura"] != null ? "${_datosUsuario!["altura"]} cm" : "--"),
                  Container(width: 1, height: 40, color: Colors.grey.withValues(alpha:0.3)),
                  _buildStatItem("Edad", _calcularEdad(_datosUsuario!["fechaNacimiento"])),
                ],
              ),
            ),
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: const Text("Actualizar Ficha Física"),
